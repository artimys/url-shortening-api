  ...
  return (
    <>
      <footer className="bg-neutral-very-dark-violet py-14">
        <div className="container flex flex-col items-center text-center lg:flex-row lg:items-start lg:justify-end lg:gap-32 lg:text-left ">
          ...
          <ul className="flex items-center gap-6 mt-12 lg:mt-0">
            <li>
              <a
              ...
              >
                ...
                >
                  <path
                    fill="#FFF"
                    className="transition duration-200 group-hover:fill-primary"
